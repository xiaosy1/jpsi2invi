...
do
    ...
    rootfile=jpsi2lplm_psip_mc09-${num}.root
    jobOptions=jobOptions_jpsi2lplm_psip_mc09-${num}.txt
    ...
    echo   "Jpsi2lplm.OutputFileName=\"/besfs/groups/nphy/users/xiaosy/bes/jpsi2invi/v0.1/run/jpsi2lplm/rootfile_mc09/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
