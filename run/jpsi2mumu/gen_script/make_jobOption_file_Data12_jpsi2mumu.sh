...
do
    ...
    rootfile=jpsi2mumu_data_psip_data12-${num}.root
    jobOptions=jobOptions_jpsi2mumu_data_psip_data12-${num}.txt
    ...
    echo   "Jpsi2incl.OutputFileName=\"/besfs/groups/nphy/users/xiaosy/bes/jpsi2invi/v0.1/run/jpsi2incl/rootfile/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
