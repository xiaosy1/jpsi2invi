...
do
    ...
    rootfile=jpsi2invi_data_psip_data09-${num}.root
    jobOptions=jobOptions_jpsi2invi_data_psip_data09-${num}.txt
    ...
    echo   "Jpsi2invi.OutputFileName=\"/besfs/groups/nphy/users/xiaosy/bes/jpsi2invi/v0.1/run/jpsi2invi/rootfile_data09/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
