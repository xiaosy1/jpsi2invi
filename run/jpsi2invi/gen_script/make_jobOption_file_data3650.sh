...
do
    ...
    rootfile=jpsi2invi_data3650-${num}.root
    jobOptions=jobOptions_jpsi2invi_data3650-${num}.txt
    ...
    echo   "Jpsi2invi.OutputFileName=\"/besfs/groups/nphy/users/xiaosy/bes/jpsi2invi/v0.1/run/jpsi2invi/rootfile_data3650/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
