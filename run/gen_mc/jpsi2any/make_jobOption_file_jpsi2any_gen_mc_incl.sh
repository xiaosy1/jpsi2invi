...
do
    ...
    rootfile=mc12_any_jpsi2incl-${num}.root
    jobOptions=jobOptions_jpsi2any_gen_mc_any-${num}.txt
    ...
    echo   "Jpsi2incl.OutputFileName=\"../rootfile_any/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
