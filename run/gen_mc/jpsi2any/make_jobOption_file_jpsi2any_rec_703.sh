...
for num in {1..300}
do
    dstfile=jpsi2any_rec-${num}.dst
	rndmseed=`expr ${num} + 1000`
	jobOptions=jobOptions_rec_any-${num}.txt
    ...
    echo   "EventCnvSvc.digiRootInputFile = {\"../../rtraw/any-${num}.rtraw\"};                 " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
	echo   "//ROOT output data file                                       " >> ${JobText_SaveDir}/${jobOptions}
    echo   "EventCnvSvc.digiRootOutputFile =\"../../dst/703/any-${num}.dst\";                     " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
