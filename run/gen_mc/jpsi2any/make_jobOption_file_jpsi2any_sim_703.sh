...
do
    ...
    echo   "EvtDecay.userDecayTableName = \"\$HOME//bes/jpsi2invi/v0.1/run/gen_mc/jpsi2any/any.dec\";             " >> ${JobText_SaveDir}/${jobOptions}
    # echo   "EvtDecay.PdtTableDir = \"\$HOME//bes/jpsi2invi/v0.1/run/gen_mc/jpsi2any/mypdt.table\";                       " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
