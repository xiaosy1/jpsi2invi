...
do
    ...
    rootfile=gen_mc_mumu_jpsi2invi_703-${num}.root
    jobOptions=jobOptions_jpsi2invi_gen_mc_mumu-${num}.txt
    ...
    echo   "Jpsi2invi.OutputFileName=\"../rootfile_mumu_703/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
