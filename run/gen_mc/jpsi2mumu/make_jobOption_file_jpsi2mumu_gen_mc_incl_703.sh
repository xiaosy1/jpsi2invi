...
for num in {1..15}
do
    file_list=gen_mc_jpsi2mumu_3G-${num}.txt
    rootfile=gen_mc_mumu_jpsi2incl_703-${num}.root
    jobOptions=jobOptions_jpsi2incl_gen_mc_mumu-${num}.txt
    ...
    echo   "#include \"\$HOME/bes/jpsi2invi/v0.1/run/gen_mc/jpsi2mumu/job_text/samples/mumu_703/$file_list\" " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "Jpsi2incl.OutputFileName=\"../rootfile_mumu_703/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
