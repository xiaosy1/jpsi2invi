...
for num in {1..300}
do
    rtrawfile=jpsi2mumu_sim-${num}.rtraw
    ...
    echo   "EvtDecay.userDecayTableName = \"\$HOME/bes/jpsi2invi/v0.1/run/gen_mc/jpsi2mumu/mumu.dec\";             " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "RealizationSvc.RunIdList = {-27090,0,-25338};                           " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "#include \"\$ROOTIOROOT/share/jobOptions_Digi2Root.txt\"         " >> ${JobText_SaveDir}/${jobOptions}
    echo   "RootCnvSvc.digiRootOutputFile = \"../../rtraw/mumu-${num}.rtraw\";                         " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
