...
for num in {1..3}
do
    file_list=gen_mc_jpsi2mumu_20G-${num}.txt
    rootfile=gen_mc_mumu_truth-${num}.root
    jobOptions=jobOptions_truth_gen_mc_mumu-${num}.txt
    ...
    echo   "#include \"\$HOME/bes/jpsi2invi/v0.1/run/gen_mc/jpsi2mumu/job_text/samples/jpsi2mumu/$file_list\" " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "Jpsi.OutputFileName=\"../rootfile_mumu_truth/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
