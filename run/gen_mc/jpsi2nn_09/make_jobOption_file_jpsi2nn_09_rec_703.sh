...
for num in {1..200}
do
    dstfile=jpsi2nn_rec-${num}.dst
	rndmseed=`expr ${num} + 1000`
	jobOptions=jobOptions_rec_nn-${num}.txt
    ...
    echo   "EventCnvSvc.digiRootInputFile = {\"../../rtraw/nn-${num}.rtraw\"};                 " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
	echo   "//ROOT output data file                                       " >> ${JobText_SaveDir}/${jobOptions}
    echo   "EventCnvSvc.digiRootOutputFile =\"../../dst/703/nn-${num}.dst\";                     " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
