...
do
    ...
    rootfile=gen_mc_ee_09_truth-${num}.root
    jobOptions=jobOptions_truth_gen_mc_ee_09-${num}.txt
    ...
    echo   "Jpsi.OutputFileName=\"../rootfile_ee_09_truth/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
