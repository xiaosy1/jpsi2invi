...
do
    ...
    rootfile=gen_mc_geta_09_jpsi2invi-${num}.root
    jobOptions=jobOptions_jpsi2invi_gen_mc_geta_09-${num}.txt
    ...
    echo   "Jpsi2invi.OutputFileName=\"../rootfile_geta_09/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
