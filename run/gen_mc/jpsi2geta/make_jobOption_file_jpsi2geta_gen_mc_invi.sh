...
for num in {1..6}
do
    file_list=gen_mc_jpsi2geta_1G-${num}.txt
    rootfile=gen_mc_geta_jpsi2invi-${num}.root
    jobOptions=jobOptions_jpsi2invi_gen_mc_geta-${num}.txt
    ...
    echo   "#include \"\$HOME/bes/jpsi2invi/v0.1/run/gen_mc/jpsi2geta/job_text/samples/$file_list\" " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "Jpsi2invi.OutputFileName=\"../rootfile_geta/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
