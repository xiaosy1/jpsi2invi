...
for num in {1..50}
do
    rtrawfile=jpsi2geta_sim-${num}.rtraw
    rndmseed=`expr ${num} + 1000`
	jobOptions=jobOptions_sim_geta-${num}.txt
    ...
    echo   "EvtDecay.userDecayTableName = \"\$HOME/bes/jpsi2invi/v0.1/run/gen_mc/jpsi2geta/geta.dec\";             " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "RootCnvSvc.digiRootOutputFile = \"../rtraw/geta-${num}.rtraw\";                         " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
