...
do
    ...
    rootfile=gen_mc_any_09_incl-${num}.root
    jobOptions=jobOptions_incl_gen_mc_any_09-${num}.txt
    ...
    echo   "Jpsi2incl.OutputFileName=\"../rootfile_any_09/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
