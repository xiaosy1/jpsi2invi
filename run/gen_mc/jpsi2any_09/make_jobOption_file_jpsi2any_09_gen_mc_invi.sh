...
for num in {1..15}
do
    file_list=gen_mc_jpsi2any_09_5G-${num}.txt
    rootfile=gen_mc_any_09_invi-${num}.root
    jobOptions=jobOptions_invi_gen_mc_any_09-${num}.txt
    ...
    echo   "#include \"\$HOME/bes/jpsi2invi/v0.1/run/gen_mc/jpsi2any_09/job_text/samples/$file_list\" " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "Jpsi2invi.OutputFileName=\"../rootfile_invi_09/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
