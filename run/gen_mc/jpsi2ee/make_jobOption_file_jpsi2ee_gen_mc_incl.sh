...
do
    ...
    rootfile=gen_mc_ee_jpsi2incl-${num}.root
    jobOptions=jobOptions_jpsi2incl_gen_mc_ee-${num}.txt
    ...
    echo   "Jpsi2incl.OutputFileName=\"../rootfile_ee/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
