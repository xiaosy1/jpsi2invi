...
do
    ...
    rootfile=gen_mc_ee_jpsi2lplm-${num}.root
    jobOptions=jobOptions_jpsi2lplm_gen_mc_ee-${num}.txt
    ...
    echo   "Jpsi2lplm.OutputFileName=\"../rootfile_ee/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
