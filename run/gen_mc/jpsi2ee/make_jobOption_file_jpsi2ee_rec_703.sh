...
for num in {1..300}
do
    dstfile=jpsi2ee_rec-${num}.dst
	rndmseed=`expr ${num} + 1000`
	jobOptions=jobOptions_rec_ee-${num}.txt
    ...
    echo   "EventCnvSvc.digiRootInputFile = {\"../../rtraw/ee-${num}.rtraw\"};                 " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
	echo   "//ROOT output data file                                       " >> ${JobText_SaveDir}/${jobOptions}
    echo   "EventCnvSvc.digiRootOutputFile =\"../../dst/703/ee-${num}.dst\";                     " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
