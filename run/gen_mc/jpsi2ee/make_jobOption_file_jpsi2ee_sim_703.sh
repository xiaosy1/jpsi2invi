...
for num in {1..300}
do
    rtrawfile=jpsi2ee_sim-${num}.rtraw
    ...
    echo   "EvtDecay.userDecayTableName = \"\$HOME/bes/jpsi2invi/v0.1/run/gen_mc/jpsi2ee/ee.dec\";             " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "RootCnvSvc.digiRootOutputFile = \"../../rtraw/ee-${num}.rtraw\";                         " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
