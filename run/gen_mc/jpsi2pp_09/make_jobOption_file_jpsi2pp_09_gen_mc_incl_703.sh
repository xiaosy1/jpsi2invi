...
for num in {1..11}
do
    file_list=gen_mc_jpsi2pp_09_3G-${num}.txt
    rootfile=gen_mc_pp_09_jpsi2incl_703-${num}.root
    jobOptions=jobOptions_jpsi2incl_gen_mc_pp_09-${num}.txt
    ...
    echo   "#include \"\$HOME/bes/jpsi2invi/v0.1/run/gen_mc/jpsi2pp_09/job_text/samples/pp703/$file_list\" " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "Jpsi2incl.OutputFileName=\"../rootfile_pp_09_703/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
