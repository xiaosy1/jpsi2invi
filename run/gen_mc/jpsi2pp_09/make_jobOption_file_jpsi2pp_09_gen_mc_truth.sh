...
for num in {1..7}
do
    file_list=gen_mc_jpsi2pp_09_5G-${num}.txt
    rootfile=gen_mc_pp_09_truth-${num}.root
    jobOptions=jobOptions_truth_gen_mc_pp_09-${num}.txt
    ...
    echo   "#include \"\$HOME/bes/jpsi2invi/v0.1/run/gen_mc/jpsi2pp_09/job_text/samples/$file_list\" " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "Jpsi.OutputFileName=\"../rootfile_pp_09_truth/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
