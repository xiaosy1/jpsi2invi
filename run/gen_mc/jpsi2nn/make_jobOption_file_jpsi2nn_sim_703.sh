...
for num in {1..200}
do
    rtrawfile=jpsi2nn_sim-${num}.rtraw
    ...
    echo   "EvtDecay.userDecayTableName = \"\$HOME/bes/jpsi2invi/v0.1/run/gen_mc/jpsi2nn/nn.dec\";             " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "RootCnvSvc.digiRootOutputFile = \"../../rtraw/nn-${num}.rtraw\";                         " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
