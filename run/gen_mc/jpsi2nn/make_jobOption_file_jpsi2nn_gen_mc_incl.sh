...
for num in {1..1}
do
    file_list=gen_mc_jpsi2nn_20G-${num}.txt
    rootfile=gen_mc_nn_jpsi2incl-${num}.root
    ...
    echo   "#include \"\$HOME/bes/jpsi2invi/v0.1/run/gen_mc/jpsi2nn/job_text/samples/jpsi2nn/$file_list\" " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "Jpsi2incl.OutputFileName=\"../rootfile_nn/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
