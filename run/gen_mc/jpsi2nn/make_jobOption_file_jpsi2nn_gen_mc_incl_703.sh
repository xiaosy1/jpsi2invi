...
for num in {1..6}
do
    file_list=gen_mc_jpsi2nn_3G-${num}.txt
    rootfile=gen_mc_nn_jpsi2incl_703-${num}.root
    jobOptions=jobOptions_jpsi2incl_gen_mc_nn-${num}.txt
    ...
    echo   "#include \"\$HOME/bes/jpsi2invi/v0.1/run/gen_mc/jpsi2nn/job_text/samples/nn_703/$file_list\" " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "Jpsi2incl.OutputFileName=\"../rootfile_nn_703/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
