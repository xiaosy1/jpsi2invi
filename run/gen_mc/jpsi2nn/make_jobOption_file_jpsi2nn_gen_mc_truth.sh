...
do
    ...
    rootfile=gen_mc_nn_truth-${num}.root
    jobOptions=jobOptions_truth_gen_mc_nn-${num}.txt
    ...
    echo   "Jpsi.OutputFileName=\"../rootfile_nn_truth/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
