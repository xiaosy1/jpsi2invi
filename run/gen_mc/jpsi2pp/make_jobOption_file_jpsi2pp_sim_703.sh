...
for num in {1..200}
do
    rtrawfile=jpsi2pp_sim-${num}.rtraw
    ...
    echo   "EvtDecay.userDecayTableName = \"\$HOME/bes/jpsi2invi/v0.1/run/gen_mc/jpsi2pp/pp.dec\";             " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "RootCnvSvc.digiRootOutputFile = \"../../rtraw/pp-${num}.rtraw\";                         " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
