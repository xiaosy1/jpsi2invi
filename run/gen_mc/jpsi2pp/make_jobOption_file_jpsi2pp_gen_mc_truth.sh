...
for num in {1..2}
do
    file_list=gen_mc_jpsi2pp_20G-${num}.txt
    rootfile=gen_mc_pp_truth-${num}.root
    jobOptions=jobOptions_truth_gen_mc_pp-${num}.txt
    ...
    echo   "#include \"\$HOME/bes/jpsi2invi/v0.1/run/gen_mc/jpsi2pp/job_text/samples/jpsi2pp/$file_list\" " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "Jpsi.OutputFileName=\"../rootfile_pp_truth/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
