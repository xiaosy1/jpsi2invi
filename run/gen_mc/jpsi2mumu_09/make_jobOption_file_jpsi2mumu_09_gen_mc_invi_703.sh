...
do
    ...
    rootfile=gen_mc_mumu_09_jpsi2invi_703-${num}.root
    jobOptions=jobOptions_jpsi2invi_gen_mc_mumu_09-${num}.txt
    ...
    echo   "Jpsi2invi.OutputFileName=\"../rootfile_mumu_09_703/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
