...
for num in {1..10}
do
    file_list=gen_mc_jpsi2mumu_09_5G-${num}.txt
    rootfile=gen_mc_mumu_09_truth-${num}.root
    jobOptions=jobOptions_truth_gen_mc_mumu_09-${num}.txt
    ...
    echo   "#include \"\$HOME/bes/jpsi2invi/v0.1/run/gen_mc/jpsi2mumu_09/job_text/samples/$file_list\" " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "ApplicationMgr.DLLs += {\"Jpsi\"};                       " >> ${JobText_SaveDir}/${jobOptions}
    echo   "ApplicationMgr.TopAlg += { \"Jpsi\" };                   " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "Jpsi.IsMonteCarlo=\"true\";                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "Jpsi.OutputFileName=\"../rootfile_mumu_09_truth/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
