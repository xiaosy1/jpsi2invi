...
do
    ...
    rootfile=gen_mc_mumu_09_jpsi2lplm-${num}.root
    jobOptions=jobOptions_jpsi2lplm_gen_mc_mumu_09-${num}.txt
    ...
    echo   "Jpsi2lplm.OutputFileName=\"../rootfile_mumu_09/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
