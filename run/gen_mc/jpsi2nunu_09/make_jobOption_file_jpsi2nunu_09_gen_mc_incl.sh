...
for num in {1..4}
do
    file_list=gen_mc_jpsi2nunu_09_1G-${num}.txt
    rootfile=gen_mc_nunu_09_jpsi2incl-${num}.root
    jobOptions=jobOptions_jpsi2incl_gen_mc_nunu_09-${num}.txt
    ...
    echo   "#include \"\$HOME/bes/jpsi2invi/v0.1/run/gen_mc/jpsi2nunu_09/job_text/samples/$file_list\" " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "Jpsi2incl.OutputFileName=\"../rootfile_nunu_09/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
