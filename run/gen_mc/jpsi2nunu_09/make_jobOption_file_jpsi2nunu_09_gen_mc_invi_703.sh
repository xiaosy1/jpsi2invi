...
for num in {1..2}
do
    file_list=gen_mc_jpsi2nunu_09_3G-${num}.txt
    rootfile=gen_mc_nunu_09_jpsi2invi_703-${num}.root
    jobOptions=jobOptions_jpsi2invi_gen_mc_nunu_09-${num}.txt
    ...
    echo   "#include \"\$HOME/bes/jpsi2invi/v0.1/run/gen_mc/jpsi2nunu_09/job_text/samples/nunu703/$file_list\" " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "Jpsi2invi.OutputFileName=\"../rootfile_nunu_09_703/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
