...
JobText_SaveDir=job_text/sim/703

for num in {1..50}
do
    rtrawfile=jpsi2nunu_sim-${num}.rtraw
    rndmseed=`expr ${num} + 1000`
	jobOptions=jobOptions_sim_nunu-${num}.txt
    ...
    echo   "KKMC.BeamEnergySpread=0.0013;                                                              " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "EvtDecay.userDecayTableName = \"\$HOME/bes/jpsi2invi/v0.1/run/gen_mc/jpsi2nunu_09/nunu.dec\";             " >> ${JobText_SaveDir}/${jobOptions}
    # echo   "EvtDecay.PdtTableDir = \"../../mypdt.table\";                       " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "RealizationSvc.RunIdList = {-25338,0,-27090};                           " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "#include \"\$ROOTIOROOT/share/jobOptions_Digi2Root.txt\"         " >> ${JobText_SaveDir}/${jobOptions}
    echo   "RootCnvSvc.digiRootOutputFile = \"../../rtraw/nunu-${num}.rtraw\";                         " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
