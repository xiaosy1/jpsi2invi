...
JobText_SaveDir=job_text/rec/703

for num in {1..50}
do
    dstfile=jpsi2nunu_rec-${num}.dst
	rndmseed=`expr ${num} + 1000`
	jobOptions=jobOptions_rec_nunu-${num}.txt
    ...
    echo   "EventCnvSvc.digiRootInputFile = {\"../../rtraw/nunu-${num}.rtraw\"};                 " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
	echo   "//ROOT output data file                                       " >> ${JobText_SaveDir}/${jobOptions}
    echo   "EventCnvSvc.digiRootOutputFile =\"../../dst/703/nunu-${num}.dst\";                     " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
