...
do
    ...
    rootfile=jpsi2incl_psip_mc09-${num}.root
    jobOptions=jobOptions_jpsi2incl_psip_mc09-${num}.txt
    ...
    echo   "Jpsi2incl.OutputFileName=\"/besfs/groups/nphy/users/xiaosy/bes/jpsi2invi/v0.1/run/jpsi2incl/rootfile_mc09/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
