...
JobText_SaveDir=../job_text/data3650

for num in {1..84}
do
    file_list=data_663p01_3650_20G-${num}.txt
    rootfile=jpsi2incl_data3650-${num}.root
    jobOptions=jobOptions_jpsi2incl_data3650-${num}.txt
    ...
    echo   "#include \"\$HOME/bes/jpsi2invi/v0.1/run/samples/data3650/$file_list\" " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "Jpsi2incl.OutputFileName=\"/besfs/groups/nphy/users/xiaosy/bes/jpsi2invi/v0.1/run/jpsi2incl/rootfile_data3650/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
