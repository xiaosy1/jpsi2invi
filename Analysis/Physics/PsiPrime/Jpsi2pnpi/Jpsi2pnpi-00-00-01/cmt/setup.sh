...
${CMTROOT}/mgr/cmt setup -sh -pack=Jpsi2pnpi -version=Jpsi2pnpi-00-00-01 -path=/afs/ihep.ac.cn/users/k/kiuchi/bes/jpsi2pnpi/v0.1/Analysis/Physics/PsiPrime  -no_cleanup $* >${tempfile}; . ${tempfile}
/bin/rm -f ${tempfile}
