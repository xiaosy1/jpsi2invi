...
#         ;;
    ...
    1.5.1) echo "Get samples"
        ./python/get_samples.py /afs/ihep.ac.cn/users/x/xiaosy/v0.1/run/gen_mc/jpsi2mumu/job_text/dst/703 run/gen_mc/jpsi2mumu/job_text/samples/mumu_703/gen_mc_jpsi2mumu.txt 3G
        ./python/get_samples.py /afs/ihep.ac.cn/users/x/xiaosy/v0.1/run/gen_mc/jpsi2ee/job_text/dst/703 run/gen_mc/jpsi2ee/job_text/samples/ee_703/gen_mc_jpsi2ee.txt 3G
        ./python/get_samples.py /afs/ihep.ac.cn/users/x/xiaosy/v0.1/run/gen_mc/jpsi2nn/job_text/dst/703 run/gen_mc/jpsi2nn/job_text/samples/nn_703/gen_mc_jpsi2nn.txt 3G
        ./python/get_samples.py /afs/ihep.ac.cn/users/x/xiaosy/v0.1/run/gen_mc/jpsi2pp/job_text/dst/703 run/gen_mc/jpsi2pp/job_text/samples/pp_703/gen_mc_jpsi2pp.txt 3G
        ./python/get_samples.py /afs/ihep.ac.cn/users/x/xiaosy/v0.1/run/gen_mc/jpsi2nunu/job_text/dst/703 run/gen_mc/jpsi2nunu/job_text/samples/nunu_703/gen_mc_jpsi2nunu.txt 3G
        ;;
    ...
    1.5.5) echo "Check Condor jobs on generated MC sample..."
	   ./python/chk_condorjobs.py run/gen_mc/jpsi2mumu/job_text/rootfile_mumu_703  15
	   ./python/chk_condorjobs.py run/gen_mc/jpsi2ee/job_text/rootfile_ee_703  15
	   ./python/chk_condorjobs.py run/gen_mc/jpsi2nn/job_text/rootfile_nn_703  6
	   ./python/chk_condorjobs.py run/gen_mc/jpsi2pp/job_text/rootfile_pp_703  11
	   ./python/chk_condorjobs.py run/gen_mc/jpsi2nunu/job_text/rootfile_nunu_703  2
	   ;;

    1.5.6)
        cd run/gen_mc/jpsi2mumu
        ./make_jobOption_file_jpsi2mumu_evtflw_invi_703.sh
        cd job_text/jobs703/
        mv jobOptions_jpsi2invi_gen_mc_mumu_evtflw_703-15.sh jobOptions_jpsi2invi_gen_mc_mumu_evtflw_703-0.sh
        chmod 755 jobOptions_jpsi2invi_gen_mc_mumu_evtflw_703-*
        cd ../../../jpsi2ee
        ./make_jobOption_file_jpsi2ee_evtflw_invi_703.sh
        cd job_text/jobs703/
        mv jobOptions_jpsi2invi_gen_mc_ee_evtflw_703-15.sh jobOptions_jpsi2invi_gen_mc_ee_evtflw_703-0.sh
        chmod 755 jobOptions_jpsi2invi_gen_mc_ee_evtflw_703-*
        cd ../../../jpsi2nn
        ./make_jobOption_file_jpsi2nn_evtflw_invi_703.sh
        cd job_text/jobs703/
        mv jobOptions_jpsi2invi_gen_mc_nn_evtflw_703-6.sh jobOptions_jpsi2invi_gen_mc_nn_evtflw_703-0.sh
        chmod 755 jobOptions_jpsi2invi_gen_mc_nn_evtflw_703-*
        cd ../../../jpsi2pp
        ./make_jobOption_file_jpsi2pp_evtflw_invi_703.sh
        cd job_text/jobs703/
        mv jobOptions_jpsi2invi_gen_mc_pp_evtflw_703-11.sh jobOptions_jpsi2invi_gen_mc_pp_evtflw_703-0.sh
        chmod 755 jobOptions_jpsi2invi_gen_mc_pp_evtflw_703-*
        cd ../../../jpsi2nunu
        ./make_jobOption_file_jpsi2nunu_evtflw_invi_703.sh
        cd job_text/jobs703/
        mv jobOptions_jpsi2invi_gen_mc_nunu_evtflw_703-2.sh jobOptions_jpsi2invi_gen_mc_nunu_evtflw_703-0.sh
        chmod 755 jobOptions_jpsi2invi_gen_mc_nunu_evtflw_703-*
        ;;
...
#         ;;
    ...
    # 1.5.9) echo "Check Condor event jobs on generated MC sample..."
	#    ./python/chk_condorjobs.py run/gen_mc/jpsi2mumu/job_text/evtflw_nunu_703 15
	#    ./python/chk_condorjobs.py run/gen_mc/jpsi2ee/job_text/evtflw_ee_703  15
	#    ./python/chk_condorjobs.py run/gen_mc/jpsi2nn/job_text/evtflw_nn_703  6
	#    ./python/chk_condorjobs.py run/gen_mc/jpsi2pp/job_text/evtflw_pp_703  11
	#    ./python/chk_condorjobs.py run/gen_mc/jpsi2nunu/job_text/evtflw_nunu_703  2
	#    ;;       
...
# 	 ;;
    ...
    3.5.1) echo "Get samples for 09"
        ./python/get_samples.py /afs/ihep.ac.cn/users/x/xiaosy/v0.1/run/gen_mc/jpsi2mumu_09/job_text/dst/703 run/gen_mc/jpsi2mumu_09/job_text/samples/mumu703/gen_mc_jpsi2mumu_09.txt 3G
        ./python/get_samples.py /afs/ihep.ac.cn/users/x/xiaosy/v0.1/run/gen_mc/jpsi2ee_09/job_text/dst/703 run/gen_mc/jpsi2ee_09/job_text/samples/ee703/gen_mc_jpsi2ee_09.txt 3G
        ./python/get_samples.py /afs/ihep.ac.cn/users/x/xiaosy/v0.1/run/gen_mc/jpsi2nn_09/job_text/dst/703 run/gen_mc/jpsi2nn_09/job_text/samples/nn703/gen_mc_jpsi2nn_09.txt 3G
        ./python/get_samples.py /afs/ihep.ac.cn/users/x/xiaosy/v0.1/run/gen_mc/jpsi2pp_09/job_text/dst/703 run/gen_mc/jpsi2pp_09/job_text/samples/pp703/gen_mc_jpsi2pp_09.txt 3G
        ./python/get_samples.py /afs/ihep.ac.cn/users/x/xiaosy/v0.1/run/gen_mc/jpsi2nunu_09/job_text/dst/703 run/gen_mc/jpsi2nunu_09/job_text/samples/nunu703/gen_mc_jpsi2nunu_09.txt 3G
        ;;
...
#         ;;
    ...
    3.5.5) echo "Check Condor jobs703 on generated MC 09 sample..."
	   ./python/chk_condorjobs.py run/gen_mc/jpsi2mumu_09/job_text/rootfile_mumu_09_703  15
	   ./python/chk_condorjobs.py run/gen_mc/jpsi2ee_09/job_text/rootfile_ee_09_703  15
	   ./python/chk_condorjobs.py run/gen_mc/jpsi2nn_09/job_text/rootfile_nn_09_703  6
	   ./python/chk_condorjobs.py run/gen_mc/jpsi2pp_09/job_text/rootfile_pp_09_703  12
	   ./python/chk_condorjobs.py run/gen_mc/jpsi2nunu_09/job_text/rootfile_nunu_09_703  2
	   ;;

    3.5.6)
        cd run/gen_mc/jpsi2mumu_09
        ./make_jobOption_file_jpsi2mumu_09_evtflw_invi_703.sh
        cd job_text/jobs703
        mv jobOptions_jpsi2invi_gen_mc_mumu_09_evtflw_703-15.sh jobOptions_jpsi2invi_gen_mc_mumu_09_evtflw_703-0.sh
        chmod 755 jobOptions_jpsi2invi_gen_mc_mumu_09_evtflw_703-*
        cd ../../../jpsi2ee_09
        ./make_jobOption_file_jpsi2ee_09_evtflw_invi_703.sh
        cd job_text/jobs703
        mv jobOptions_jpsi2invi_gen_mc_ee_09_evtflw_703-15.sh jobOptions_jpsi2invi_gen_mc_ee_09_evtflw_703-0.sh
        chmod 755 jobOptions_jpsi2invi_gen_mc_ee_09_evtflw_703-*
        cd ../../../jpsi2nn_09
        ./make_jobOption_file_jpsi2nn_09_evtflw_invi_703.sh
        cd job_text/jobs703
        mv jobOptions_jpsi2invi_gen_mc_nn_09_evtflw_703-6.sh jobOptions_jpsi2invi_gen_mc_nn_09_evtflw_703-0.sh
        chmod 755 jobOptions_jpsi2invi_gen_mc_nn_09_evtflw_703-*
        cd ../../../jpsi2pp_09
        ./make_jobOption_file_jpsi2pp_09_evtflw_invi_703.sh
        cd job_text/jobs703
        mv jobOptions_jpsi2invi_gen_mc_pp_09_evtflw_703-12.sh jobOptions_jpsi2invi_gen_mc_pp_09_evtflw_703-0.sh
        chmod 755 jobOptions_jpsi2invi_gen_mc_pp_09_evtflw_703-*
        cd ../../../jpsi2nunu_09
        ./make_jobOption_file_jpsi2nunu_09_evtflw_invi_703.sh
        cd job_text/jobs703
        mv jobOptions_jpsi2invi_gen_mc_nunu_09_evtflw_703-2.sh jobOptions_jpsi2invi_gen_mc_nunu_09_evtflw_703-0.sh
        chmod 755 jobOptions_jpsi2invi_gen_mc_nunu_09_evtflw_703-*
        ;;
...
#     # 5.0.4) echo "Generate Condor jobs on generated Jpsi->anything MC sample ---- 1..." 
# 	#    cd run/gen_mc/jpsi2any
# 	#    ./make_jobOption_file_data09_jpsi2invi.sh
# 	#    cd ../job_text/data09
# 	#    mv jobOptions_jpsi2invi_data_psip_data09-314.txt jobOptions_jpsi2invi_data_psip_data09-0.txt
...
#     # 3.1.3) echo "Test for generated Jpsi->anything MC sample" 
#     #     echo "have you changed test number?(yes / no)
#     #     ./run/jpsi2invi/job_text/data09/jobOptions_jpsi2invi_data_psip_data09-0.txt"
#     #     read opt
#     #     if [ $opt == "yes" ]
...
#     # 3.1.4) echo "Submit Condor jobs on generated Jpsi->anything MC sample ---- 2..." 
# 	#     cd run/jpsi2invi/job_text/data09
#     #     find . -name "*.out.*" | xargs rm
#     #     find . -name "*.err.*" | xargs rm	   
# 	# 	rm ../../rootfile_data09/jpsi2invi_data_psip_data09-*
...
#     # 3.1.5) echo "Check Condor jobs on generated Jpsi->anything MC sample..."
# 	#    ./python/chk_condorjobs.py run/jpsi2invi/rootfile_data09  314
# 	#    ;;
    
#     # 3.1.6) echo "Generate selection Condor jobs on generated Jpsi->anything MC sample ---- 1..."
# 	#    cd run/jpsi2invi/job_text/data09_event
#     #    find . -name "*.sh*" | xargs rm
#     #    cd ../../gen_script
# 	#    ./make_jobOption_file_data09_event.sh
...
#     # 3.1.7) echo "Test for generated Jpsi->anything MC sample event" 
# 	# 	cd run/jpsi2invi/job_text/data09_event
# 	# 	./jobOptions_jpsi2invi_data_psip_data09_event-0.sh
#     #     ;;

#     # 3.1.8) echo "Submit selection Condor jobs on generated Jpsi->anything MC sample ---- 2..." 
# 	#     cd run/jpsi2invi/job_text/data09_event
#     #     find . -name "*.out.*" | xargs rm
#     #     find . -name "*.err.*" | xargs rm	  
# 	#     rm ../../event_data09/jpsi2invi_data_psip_data09_event-*	
...
#     # 3.1.9) echo "Check Condor jobs on events generated Jpsi->anything MC sample..."
# 	#    ./python/chk_condorjobs.py run/jpsi2invi/event_data09  314
# 	#    ;;

#     # 3.1.10) echo  "Merge event root file on generated Jpsi->anything MC sample..."
# 	#    rm run/jpsi2invi/hist_data09/jpsi2invi_data_psip_data09_event_merged_1.root
# 	#    ./python/mrg_rootfiles.py  run/jpsi2invi/event_data09 run/jpsi2invi/hist_data09
# 	#    ;; 
