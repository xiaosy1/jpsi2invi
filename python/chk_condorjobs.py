...
def main():
    ...
    if logdir in ['event_mc09', 'rootfile_mc09', 'event_data09', 'rootfile_data09', 'rootfile_mumu', 'rootfile_ee', 'rootfile_nn', 'rootfile_pp',  'event_data3650', 'rootfile_data3650', 'rootfile_mc12', 'event_mc12', 'event', 'Data12_event', 'rootfile','Data12', 'data', 'mc_psip12', 'con3650', 'data09', 'mc_psip09']:
