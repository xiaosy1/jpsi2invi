...
//   jpsi2invi_rootfile =    "../run/jpsi2invi/hist/jpsi2invi_data_psip_data12_event_merged_notof.root" ;
  ...
  if(hist_id==1 || hist_id==2){
    ...
    if( g_conv_flag == 0 )
    {
       ...
       table = "invi_12_ee/invi_12_ee_fit_binned.txt" ; 
       figname = "invi_12_ee/invi_12_ee_fit_binned.eps" ;
    ...
    if( g_conv_flag == 1 )
    {
       ...
       table = "invi_12_gauss/invi_12_gauss_fit_binned.txt" ; 
       figname = "invi_12_gauss/invi_12_gauss_fit_binned.eps" ;
      ...
      //  RooFFTConvPdf signalpdf("GConvSignal", "Gaussian covoluted signal PDF", x, signalpdf1, gauss);
       RooRealVar sig1frac("sig1frac", "fraction of component 1 in signal", 0.77, 0.5, 0.999);
